...
$tmpinfogeneral = new InfoGeneral($id,'',0);
$tmpinfogeneral->obtener();
            ...
            <div class="x-content">
                <div id="main-tab">
                    <div class="x-content-title">
                        <h1>Formulario de Imagenes Informacion general</h1>
                    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <h3>Formulario Informacion general</h3>
                                    <!-- begin form-wizard -->
                                            ...
                                            <div class="wizard-step-1">
                                                <fieldset>
                                                    ...
                                                    <div class="row">
                                                        <!-- begin col-6 -->
                                                        <div class="col-md-12">
                                                            <h3 class="form-header form-header-lg m-b-10">Escriba el titutlo</h3>
                                                            <div class="height-xs">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input data-parsley-id="2967" name="titulo" id="titulo" class="form-control input-lg" data-parsley-group="wizard-step-1" value="<?php echo $tmpinfogeneral->titulo  ?>" required type="text"><ul id="parsley-id-2967" class="parsley-errors-list"></ul>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
