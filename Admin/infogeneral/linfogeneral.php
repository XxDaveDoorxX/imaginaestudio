...
include_once('../../Class/InfoGeneral.php');
...
$tmpinfog = new InfoGeneral(0,'', $id);
$infogeneral = $tmpinfog->listar_x_id_serv();
            ...
            <div class="x-content">
                <div id="main-tab">
                    <div class="x-content-title">
                        <h1>Listado imagenes de Informacion general</h1>
                        <div class="pull-right">
                            <a class="btn btn-danger" href="finfogeneral.php?id_serv=<?php echo $tmpserv->id ?>"><i class="fa fa-bars"></i> Agregar imagenes de informacion general</a>
                        </div>
                    </div>
                                        ...
                                        <table class="table datatable">
                                            ...
                                            foreach ($infogeneral as $e) {
                                                ...
                                                <tr id="trow_<?php echo $e['id']; ?>">
                                                    ...
                                                    <td>
                                                        <a class="btn btn-info btn-rounded btn-condensed" href='finfogeneral.php?id=<?php echo $e['id']?>&id_serv=<?php echo $tmpserv->id ?>'><span class="fa fa-pencil"></span></a>
