            ...
            <div class="x-content">
                <div id="main-tab">
                    <div class="x-content-title">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-danger" href="data.php"><span class="fa fa-bars"></span> Exportar a Excel</a>
                        </div>
                    </div>
                                        ...
                                        <table class="table datatable">
                                            ...
                                            ?>
                                                <tr id="trow_<?php echo $e['id']; ?>">
                                                    ...
                                                    <td>
                                                        <button class="btn btn-danger btn-rounded btn-condensed btn-sm delte_row_data" onClick="delete_contacto('trow_<?php echo $e['id']; ?>',this);" data-id="<?php echo $e['id']; ?>"><span class="fa fa-times"></span></button>
                                                    </td>
                                                </tr>
                                                <?php
                                                    }
