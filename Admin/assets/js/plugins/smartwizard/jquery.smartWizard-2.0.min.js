...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        next : $('<a>'+options.labelNext+'</a>').attr("href","#").addClass("btn btn-default pull-right"),
        previous : $('<a>'+options.labelPrevious+'</a>').attr("href","#").addClass("btn btn-default pull-left"),
        finish  : $('<a>'+options.labelFinish+'</a>').attr("href","#").addClass("btn btn-primary pull-right")
    };
