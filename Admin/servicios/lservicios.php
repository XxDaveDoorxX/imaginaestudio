...
$tmpserv = new Servicio(0,'','',0,array());
$servicios = $tmpserv->listar();


$clsftmp = new Clasificador(0);
$clasif = $clsftmp->listar_Clasificadores();
foreach ($clasif as $idx => $e) {
    $txtarb = explode('/',$clasif[$idx]['ruta']);
    $txtarb = array_filter($txtarb);
    $arb = "";
    foreach ($txtarb as $se) {
        $arb .= $clasif[$se]['nombre']."-><br />";
    }
    $clasif[$idx]['txtruta'] = $arb.$e['nombre'];
}
            ...
            <div class="x-content">
                <div id="main-tab">
                    <div class="x-content-title">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-danger" href="fservicios.php"><span class="fa fa-bars"></span> Agregar Servicio</a>
                        </div>
                    </div>
                                        ...
                                        <table class="table datatable">
                                            ...
                                            foreach ($servicios as $e) {
                                                ...
                                                <tr id="trow_<?php echo $e['id']; ?>">
                                                    ...
                                                    <?php
                                                    $desc = (strlen($e['descripcion'])<50)?($e['descripcion']):(substr($e['descripcion'],0,50)."...");
                                                    ?>
                                                    ...
                                                    $str = "&nbsp;>-";
                                                    $tps="";
                                                    foreach($e['clasificadores']->id_sc as $c_elem) {
                                                        $tps .= $clasif[$c_elem]['txtruta'];
                                                        $str = $tps;
                                                        $tps .= "<br/>";
                                                    }
                                                    ?>
                                                    <td><?php echo $str ?></td>
                                                    <td style="text-align: center;"><a href="../muestras/lmuestra.php?id_serv=<?php echo $e['id'] ?>" style="text-align: center; font-size: 25px;"><i class="fa fa-picture-o" aria-hidden="true"></i></a></td>
                                                    <td style="text-align: center;"><a href="../infogeneral/linfogeneral.php?id_serv=<?php echo $e['id'] ?>" style="text-align: center; font-size: 25px;"><i class="fa fa-picture-o" aria-hidden="true"></i></a></td>
                                                    <td>
                                                        <a class="btn btn-info btn-rounded btn-condensed" href='fservicios.php?id=<?php echo $e['id']?>'>Editar</a>
